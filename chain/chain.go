...
import (
	...
	dosrpcclient "gogs.doschain.org/doschain/dosd/rpcclient"
...
type RPCClient struct {
	*dosrpcclient.Client
	connConfig  *dosrpcclient.ConnConfig // Work around unexported field
...
func NewRPCClient(chainParams *chaincfg.Params, connect, user, pass string, certs []byte,
	...
	return NewRPCClientConfig(chainParams, &dosrpcclient.ConnConfig{
		Host:                 connect,
		Endpoint:             "ws",
		User:                 user,
		Pass:                 pass,
...
func NewRPCClientConfig(chainParams *chaincfg.Params, connConfig *dosrpcclient.ConnConfig) (*RPCClient, error) {
	client := &RPCClient{
	...
	ntfnCallbacks := &dosrpcclient.NotificationHandlers{
	...
	rpcClient, err := dosrpcclient.New(client.connConfig, ntfnCallbacks)
	if err != nil {
		return nil, err
	}
...
func (c *RPCClient) Start(ctx context.Context, retry bool) (err error) {
	...
	if err != nil {
		return errors.E(op, errors.E(errors.Op("dosd.jsonrpc.getcurrentnet"), err))
	}
...
// dosrpcclient callbacks, which isn't very Go-like and doesn't allow
...
// POSTClient creates the equivalent HTTP POST dosrpcclient.Client.
func (c *RPCClient) POSTClient() (*dosrpcclient.Client, error) {
	configCopy := *c.connConfig
	configCopy.HTTPPostMode = true
	client, err := dosrpcclient.New(&configCopy, nil)
	if err != nil {
