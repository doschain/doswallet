...
import (
	...
	"gogs.doschain.org/doschain/doswallet/validate"
...
func (b *Syncer) GetAbi(ctx context.Context, address string) (string, error) {
	return "", nil
}
func (b *Syncer) GetNonce(ctx context.Context, address string) (uint64, error) {
	return 0, nil
}
...
// interface.
func (s *Syncer) LoadTxFilter(ctx context.Context, reload bool, addrs []dosutil.Address, outpoints []wire.OutPoint) error {
	s.filterMu.Lock()
...
func (s *Syncer) StakeDifficulty(ctx context.Context) (dosutil.Amount, error) {
