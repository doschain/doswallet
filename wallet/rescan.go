...
func NewRescanFilter(addresses []dosutil.Address, unspentOutPoints []*wire.OutPoint) *RescanFilter {
	filter := &RescanFilter{
		pubKeyHashes:        map[[ripemd160.Size]byte]struct{}{},
		scriptHashes:        map[[ripemd160.Size]byte]struct{}{},
		compressedPubKeys:   map[[33]byte]struct{}{},
...
func (f *RescanFilter) AddAddress(a dosutil.Address) {
	switch a := a.(type) {
	case *dosutil.AddressPubKeyHash:
		f.pubKeyHashes[*a.Hash160()] = struct{}{}
	case *dosutil.AddressScriptHash:
...
func (f *RescanFilter) ExistsAddress(a dosutil.Address) (ok bool) {
	switch a := a.(type) {
	case *dosutil.AddressPubKeyHash:
...
func (f *RescanFilter) RemoveAddress(a dosutil.Address) {
	switch a := a.(type) {
	case *dosutil.AddressPubKeyHash:
