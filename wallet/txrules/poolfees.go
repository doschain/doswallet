...
func StakePoolTicketFee(stakeDiff dosutil.Amount, relayFee dosutil.Amount,
	height int32, poolFee float64, params *chaincfg.Params) dosutil.Amount {
	...
	return dosutil.Amount(num.Int64())
}
