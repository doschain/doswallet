...
import (
	...
	hd "gogs.doschain.org/doschain/dosd/hdkeychain"
	rpc "gogs.doschain.org/doschain/dosd/rpcclient"
...
func (f *existsAddrIndexFinder) addressesUsed(addrs []dosutil.Address) (bitset.Bytes, error) {
	const op errors.Op = "dosd.jsonrpc.existsaddresses"
