...
type NetworkBackend interface {
	Peer
	LoadTxFilter(ctx context.Context, reload bool, addrs []dosutil.Address, outpoints []wire.OutPoint) error
	...
	StakeDifficulty(ctx context.Context) (dosutil.Amount, error)
}
