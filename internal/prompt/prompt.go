...
func Seed(reader *bufio.Reader) (seed []byte, upgradeSLIP44 bool, err error) {
	...
	for {
		...
		upgradeSLIP44, err := promptListBool(reader, "Do you want to upgrade the SLIP44 coin type to use?", "yes")
		if err != nil {
			return nil, false, err
		}

		return seed, upgradeSLIP44, nil
	}
}
...
func Setup(r *bufio.Reader, insecurePubPass, configPubPass []byte) (privPass, pubPass, seed []byte, upgradeSLIP44 bool, err error) {
