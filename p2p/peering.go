...
import (
	...
	"gogs.doschain.org/doschain/dosd/connmgr"
	...
	"gogs.doschain.org/doschain/doswallet/lru"
...
func (lp *LocalPeer) newMsgVersion(pver uint32, extaddr net.Addr, c net.Conn) (*wire.MsgVersion, error) {
	...
	v := wire.NewMsgVersion(la, ra, nonce, 0, 0, [20]byte{})
...
func (b *RemotePeer) GetAbi(ctx context.Context, address string) (string, error) {
	return "", nil
}

func (b *RemotePeer) GetNonce(ctx context.Context, address string) (uint64, error) {
	return 0, nil
}
